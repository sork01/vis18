...
protected:
    ...
    // Find the offset of a certain intermediate value using linear interpolation
    // Example: offsetInLinearInterpolation(0.0, 3.0, 2.0) = 0.666666...
    double offsetInLinearInterpolation(double f0, double f1, double val);
	
    // Draw a single isoline
    void drawIsoLine(const VolumeRAM* vol, IndexBufferRAM* idxbuf, 
